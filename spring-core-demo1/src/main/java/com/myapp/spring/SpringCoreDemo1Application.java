...
public class SpringCoreDemo1Application {
	...
	public static void main(String[] args) {
		...
		System.out.println(
			repository.save(new Movie("1", "Passenger", "Science Fiction", "A thief enters dreams to steal secrets."))
		);
		...
		// searchService1.search("The Matrix").forEach(System.out::println);
